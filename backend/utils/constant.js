export const messageEmails = [
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "Here’s to announce the release of our Support Centre.",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Purchased Order Not Processed",
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
  ...
  {
    title: "Your Return Has Been Delivered",
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
  ...
  },
  {
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "We appreciate your continues use of RePeddle to contribute in making a change in our environment and planet, reducing fashion footprint, while empowering yourself. ",
      },
      {
        type: "div",
        content:
          "Sadly, your order with order number has been approved for return.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "At Repeddle, our greatest mission is to challenge the negative impact of fast fashion on Africa’s environment I.E. Carbon Emission, Water Pollution & Landfills.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "Yay! You have made a sale!!",
      },
      {
        type: "div",
        content:
      ...
      },
      {
        type: "div",
        content:
          "Please head on to the order to process and complete the delivery.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "We’re Excited To Welcome You To The Repeddle Tribe",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Preparing Your Order For Delivery.",

    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content: "Your order is been prepared for delivery.  ",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Track All Important Metrics",
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "With one simple dashboard, you can track all your account analytics from Earnings, Sold Orders, Products and Purchases.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "You’ve successfully reset your RePeddle password.",
      },
      {
        type: "div",
        content: "Thanks for using RePeddle!",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "Your order has just been dropped off by the seller at your selected  delivery choice and will soon be on its way to your pick-up point/address.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      { type: "div", content: "Hi Tribe" },
      {
        type: "div",
        content:
          "We are happy to announce the release of a new feature that will help make selling, using your Repeddle store more easy, and run your business or side hustle smoothly!",
      },
      {
        type: "div",
  ...
  },
  {
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "Your order is on its way to you and will soon be delivered to your selected delivery choice ",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Let’s Get Your Email Verified.",
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "Your order has been successfully received by the buyer.",
      },
      {
        type: "div",
        content:
          "Your earning is been processed and on its way to your RePeddle Wallet.",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Your Withdrawal Request Is Been Processed.",
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "Your withdrawal request has been received and the withdrawal is been processed.",
      },
      {
        type: "div",
        content: "You initiated to withdraw : ….",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "Thank you for verifying your email and connecting with us.",
      },
      {
        type: "div",
        content:
  ...
  {
    title: "Yay.!!! Let’s Get You Back To Your Account.",
    ...
    textArray: [
      { type: "div", content: "Hi USERNAME" },
      {
        type: "div",
        content:
          "You recently requested a password reset to get access back to your RePeddle account.",
      },
      {
        type: "div",
        content:
  ...
  },
  {
    ...
    textArray: [
      ...
      {
        type: "div",
        content: "Here’s to celebrate your DATE. since you joined REPEDDLE.",
      },
      {
        type: "div",
        content:
          "Congratulations for deciding to make a change in Africa’s environment by choosing second-hand first.",
      },
      {
        type: "div",
        content:
          "As a commitment to all our community members, we want to ensure you’re enjoying your BUYING experience or that your SALE is thriving.",
      },
      {
        type: "div",
        content:
