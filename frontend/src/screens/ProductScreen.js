...
export default function ProductScreen() {
    ...
    const [
        { loading, error, product, comments, loadingCreateReview },
        dispatch,
    ] = useReducer(reducer, {
        product: [],
        loading: true,
                ...
                <div className="single_product_right">
                    ...
                    <div className="single_product_actions">
                        ...
                        <IconContainer>
                            <FontAwesomeIcon
                                onClick={() =>
                                    addConversation(product.seller._id)
                                }
                                icon={faMessage}
                            />
                    ...
                    <div className="">
                        <div className="select_size_header">
                            select size: {size}{" "}
                        </div>
                        ...
                        <div className="sp_btn">
                            ...
                            <button className="sp_wishlist_btn ">
                                wishlist
                            </button>
                        </div>
                        <div className="sp_more_detail">
                            ...
                            >
                                ...
                                <div className="sp_detail_contail">
                                    <div className="sp_condition">new</div>Item
                                    is in good conditon
                                </div>
                            </div>
                            <div
