    ...
    <div className="container small-container">
      ...
      {loading ? (
        ...
        <Form>
          ...
          <Form.Group className="mb-3" controllId="slug">
          ...
          <Form.Group className="mb-3" controllId="brand">
          ...
          <Form.Group className="mb-3" controllId="countInStock">
