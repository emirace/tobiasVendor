...
export default function ProductsScreen() {
    ...
    const sliderHandler = (direction) => {
        if (direction === "left") {
            setSliderIndex(
                sliderIndex > 0 ? sliderIndex - 1 : products.length - 5
            );
        } else {
            setSliderIndex(
                sliderIndex < products.length - 5 ? sliderIndex + 1 : 0
            );
        }
    };
                ...
                <Col position-relative>
                    ...
                    <section className="CategoryListing_section ">
                        <div className="product-title-Listing">
                            <h2 className="product-categorylisting">
                                New Collection
                            </h2>
                            <p>
                                Lorem Ipsum is simply dummy text of the printing
                                and typesetting industry. Lorem Ipsum dummy text
                        ...
                        <div className="downloadapp_section">
                            <div className="downloadapp_left">
                                <div className="downloadapp_section_text">
                                    ...
                                    Ipsum dummy text of the printing and
