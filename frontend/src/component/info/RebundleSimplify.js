  ...
  return (
    <Container>
      ...
      <p>
        ...
        for one delivery (the 1 st purchase) and get free delivery on the rest
        items you purchase from the same seller within two (2) hours window
        after the 1 st checkout.
      </p>
      <RedTitle>How It Works:</RedTitle>
      <ol>
        <li>
        ...
        <li>
          After the 1 st successful purchase, a two hours’ time window is
          ...
          Re:Bundle is active within two hours after your 1 st purchase.
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          ...
          after the 1 st purchase from the same seller. This applies whenever
        ...
        <li>
          ...
          meaning Re:Bundle window closes after two hours from the 1 st complete
          purchase checkout.
        </li>
      </ol>
    </Container>
