  ...
  return (
    <Container>
      ...
      <p>
        ...
        let go from the same seller profile/shop? You can shop them all and pay
        for <b>one delivery fee.</b>
      </p>{" "}
      <p>
        It’s simple; When you purchase an item using a preferred delivery method
        as offered by the seller, and the seller enabled “Re:Bundle” option for
        their profile, you have <b>Two Hours</b> window circle to make more
        additional purchase. By so; You only pay for the first delivery, and the
        rest items you buy from the same seller within the open two hours’
        window will be eligible for free delivery.
      </p>
      <p>
        {" "}
        This means the seller will ship all items in one package (including the
        first purchase) so you have bought multiple items, paid for one
      ...
      <p>
        {" "}
        Enabling <b>Re:Bundle</b> option in your profile/shop gives a buyer the
        opportunity to pay for one delivery fee, buy various items for the next{" "}
        <b>two hours</b> and get <b>free delivery</b> for the rest items they
        buy within that two hours window after they pay for the first delivery
        cost.
      </p>
      <p>
        When a seller enables Re:Bundle Option in their profile/shop, they will
        package all items as one package, (<i>including the first purchase</i>)
        to other purchases the same buyer has made within two hours window and
        ship as one.
      </p>
      ...
      <List>
        ...
        <li>
          <FontAwesomeIcon icon={faCircle} /> Buyers will pay for delivery only
          on the first purchase, and within two hours from that first purchase,
          they will be able to buy more items from your shop and get free
          delivery for the rest items they bought within the two hours’ window.{" "}
        </li>
        <li>
      ...
      <Center>
        ...
        />
        <div>
          <b>Purchase No 1</b> - Free delivery option is visible but grayed out
        </div>
        <PhoneImg
          src="https://res.cloudinary.com/emirace/image/upload/v1660107093/phonescreen_opkx9a.png"
          alt="imag"
