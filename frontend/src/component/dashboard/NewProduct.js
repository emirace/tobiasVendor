...
export default function NewProduct() {
    ...
    const [{ loading, error, loadingUpload, errorUpload }, dispatch] =
        useReducer(reducer, {
            loading: false,
            error: "",
            loadingUpload: false,
                ...
                <Form noValidate validated={validated} onSubmit={submitHandler}>
                    <Left>
                        ...
                        <Item>
                            ...
                            >
                                ...
                                >
                                    <MenuItem value={"Womenswear"}>
                                        Womenswear
                                    </MenuItem>
                                    <MenuItem value={"Menswear"}>
                                        Menswear
                                    </MenuItem>
                                    <MenuItem value={"Kids"}>Kids</MenuItem>
                                    <MenuItem value={"Cureve Plus"}>
                                        Cureve Plus
                                    </MenuItem>
                                </Select>
                            </FormControl>
                                ...
                                <Item>
                                    ...
                                    >
                                        <Select
                                            value={category}
                                            onChange={(e) =>
                                                setSunCategory1(e.target.value)
                                            }
                                            displayEmpty
                                            inputProps={{
                                                "aria-label": "Without label",
                    ...
                    <Right>
                        <Top>
                            ...
                            <TitleDetails>
                                You will need to add aleast one image and a max
                                of four images. Add clear and quality
                                images.Ensure ypu follow the image uplaod rules.
                            </TitleDetails>
                            <Item>
